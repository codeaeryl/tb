...
<main style="position: relative;">
    ...
    <div class="container">
        <h1>Insert Staff</h1>
        <form action="index.php?menu=staff-store" method="POST">
            <?php
            ...
            <input type="text" id="nama_staff" name="nama_staff" placeholder="Name" maxlength="100" required>
            <label for="username">Username:</label>
            <input type="text" id="username" name="username" placeholder="Username" maxlength="32" required>
            <label for="password">Password:</label>
            <input type="text" id="password" name="password" placeholder="Password" maxlength="24" required>
            <label for="password_confirm">Konfirmasi Password:</label>
            <input type="password" id="password_confirm" name="password_confirm" placeholder="Confirm Password" maxlength="24" required>
            <label for="email">Email:</label>
            <input type="email" id="email" name="email" placeholder="Email" maxlength="50" required>
            <label for="posisi">Posisi:</label>
            <input type="text" id="posisi" name="posisi" value="Staff" readonly>
