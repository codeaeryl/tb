...
<main style="position: relative;">
    ...
    <div class="container">
        <h1>Jadwal Check Out Hari Ini</h1>
        ...
        <table id="main-table" class="stripe">
            ...
            <tr>
                ...
                <td class="btn-container">
                    <form action="index.php?menu=process-checkout" method="POST" onsubmit="return confirm('Check out this guest?');">
                        <input type="hidden" name="id_reservasi" value="<?= $row->getIdReservasi() ?>">
                        <button type="submit" class="edit-btn">Check Out</button>
                    </form>
                </td>
            </tr>
            <?php endforeach; ?>
