...
<main style="position: relative;">
    ...
    <div class="container">
        <h1>Jadwal Check In Hari Ini</h1>
        ...
        <table id="main-table" class="stripe">
            ...
            <tr>
                <td><?= $row->getIdReservasi() ?></td>
                <td><?= $row->getNomorKamar() ?></td>
                <td><?= $row->getNamaTamu() ?></td>
                <td><?= $row->getTipeKamar() ?></td>
                <td class="btn-container">
                    <form action="index.php?menu=process-checkin" method="POST" onsubmit="return confirm('Check in this guest?');">
                        <input type="hidden" name="id_reservasi" value="<?= $row->getIdReservasi() ?>">
                        <button type="submit" class="edit-btn">Check In</button>
                    </form>
                    <form action="index.php?menu=process-cancel" method="POST" onsubmit="return confirm('Cancel this reservation?');">
                        <input type="hidden" name="id_reservasi" value="<?= $row->getIdReservasi() ?>">
