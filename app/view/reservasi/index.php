...
<main style="position: relative;">
    ...
    <div class="container">
        ...
        <table id="main-table" class="stripe">
            ...
            <tr>
                <td><?= $res->getIdReservasi() ?></td>
                <td><?= $res->getNamaTamu() ?></td>
                <td><?= $res->getNomorKamar() ?></td>
                <td><?= $res->getNamaTipeKamar() ?></td>
                <td><?= $res->getTanggalReservasi() ?></td>
                <td><?= $res->getTanggalCheckin() ?></td>
                <td><?= $res->getTanggalCheckout() ?></td>
                <td><?= $res->getStatusReservasi() ?></td>
                <td><?= number_format($res->getTotalHarga(), 2) ?></td>
            </tr>
            <?php endforeach; ?>
            </tbody>
            <tfoot>
