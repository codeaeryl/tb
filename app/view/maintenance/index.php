...
<main style="position: relative;">
    ...
    <div class="container">
        ...
        <?php if (isset($_GET['success'])): ?>
            <div class="suc-msg"><?= htmlspecialchars($_GET['success']) ?></div>
        <?php endif; ?>
        <?php if (isset($_GET['message'])): ?>
            <div class="err-msg"><?= htmlspecialchars($_GET['message']) ?></div>
        <?php endif; ?>
        
        <a href="index.php?menu=maintenance-add" class="add-btn">Schedule Maintenance</a>
        ...
        <table id="main-table" class="stripe">
            ...
            <tr>
                <td><?= $m->getIdMaintenance() ?></td>
                <td><?= $m->getNomorKamar() ?></td>
                <td><?= $m->getTanggalMulai() ?></td>
                <td><?= $m->getTanggalSelesai() ?></td>
                <td><?= $m->getDeskripsiMaintenance() ?></td>
                <td><?= $m->getStatusMaintenance() ?></td>
                <td class="btn-container">
                    <a href="index.php?menu=maintenance-edit&id=<?= $m->getIdMaintenance() ?>" class="edit-btn">Edit</a>
                    <form action="index.php?menu=maintenance-delete" method="POST" onsubmit="return confirm('Are you sure?');">
                        <input type="hidden" name="id_maintenance" value="<?= $m->getIdMaintenance() ?>">
