...
<head>
    ...
    <title>Laporan Performa Promo</title>
    <!-- Import jquery -->
...
<main style="position: relative;">
    ...
    <div class="container">
        ...
        <table id="main-table" class="stripe">
            ...
            <tr>
                <td><?=$promo->getKodePromo();?></td>
                <td><?=$promo->getDescPromo();?></td>
                <td><?=$promo->getJumlahPemakaian();?></td>
                <td>Rp <?=number_format($promo->getTotalPendapatan(), 2, ',', '.');?></td>
            </tr>
            <?php endforeach; ?>
            </tbody>
            <tfoot>
